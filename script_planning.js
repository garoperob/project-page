...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const ganttData = [
  { task: "Definir objetivos y alcance", startWeek: 1, duration: 1 },
  { task: "Identificar stakeholders", startWeek: 1, duration: 1 },
  { task: "Elaborar cronograma inicial", startWeek: 2, duration: 1 },
  { task: "Estimar demanda anual", startWeek: 1, duration: 1 },
  { task: "Planificar recursos e infraestructura", startWeek: 1, duration: 2 },
  ...
  { task: "Modelado del gemelo digital", startWeek: 5, duration: 1 },
  { task: "Validación y simulación digital", startWeek: 6, duration: 1 },
  { task: "Diseño de célula robotizada", startWeek: 7, duration: 1 },
  { task: "Selección de robot", startWeek: 7, duration: 1 },
  { task: "Selección de software SCADA", startWeek: 13, duration: 1 },
  { task: "Configuración inicial", startWeek: 8, duration: 1 },
  { task: "Selección de sensores", startWeek: 9, duration: 1 },
  { task: "Integración plataforma de datos", startWeek: 10, duration: 1 },
  { task: "Recepción y verificación de componentes", startWeek: 11, duration: 1 },
  { task: "Programación de robot de soldadura", startWeek: 12, duration: 0.5 },
  { task: "Selección controladores industriales", startWeek: 12, duration: 2 },
  { task: "Programación controladores", startWeek: 12, duration: 2 },
  { task: "Integracion con sistemas SCADA", startWeek: 13, duration: 3 },
  { task: "Configuración alarmas y reportes", startWeek: 14, duration: 2 },
  { task: "Integración de modulos y sistemas", startWeek: 14, duration: 2 },
  { task: "Determinación viabilidad financiera", startWeek: 15, duration: 1 }
];
